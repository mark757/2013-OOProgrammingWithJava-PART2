...
public class MovingTest<_Thing, _Item, _Laatikko, _Packer> {
    ...
    String itemString = "moving.domain.Thing.Item";
    ...
    public void classItemPublic() {
        String klassName = "moving.domain.Thing.Item";
    ...
    public void itemGetVolume() throws Throwable {
        ...
        assertTrue("Class " + s(klassName) + " should have method public int getVolume()", _ItemRef.method(item, "getVolume").returning(int.class).takingNoParams().
    ...
    public void itemGetName() throws Throwable {
        ...
        assertTrue("Class " + s(klassName) + " should have method public String getName()", _ItemRef.method(item, "getName").returning(String.class).takingNoParams().
                withNiceError("Error caused by code: \n" + v).isPublic());
    ...
    public void itemCompareTo() throws Throwable {
        ...
        assertTrue("Class " + klassName + " should have method public int compareTo(Item comparable)", _ItemRef.method(item, "compareTo").returning(int.class).taking(_ItemRef.cls()).
                withNiceError("Error caused by code: \n" + v).isPublic());
    ...
    public void boxMethodAdd() throws Throwable {
        ...
        assertTrue("Class " + s(klassName) + " should have method " + "public boolean addThing(Thing t)", _LaatikkoRef.method(box, "addThing").returning(boolean.class).taking(_ThingRef.cls()).
                withNiceError("Error caused by code: \n" + v).isPublic());
    ...
    public void boxGetVolume() throws Throwable {
        ...
        String v = "Box box = new Box(1000);" + "box.getVolume(  );\n";

        assertTrue("Class " + klassName + " should have method public int getVolume()", _LaatikkoRef.method(box, "getVolume").returning(int.class).takingNoParams().
                withNiceError("Error caused by code: \n" + v).isPublic());
    ...
    public void packerMethodPackThings() throws Throwable {
        ...
        assertTrue("Class " + s(klassName) + " should have method " + "public List<Box> packThings(List<Thing> things)", _PackerRef.method(pakaaja, "packThings").returning(List.class).taking(List.class).
                withNiceError("Error caused by code: \n" + v).isPublic());
    ...
    public void packerWorks() throws Throwable {
        ...
        try {
            ...
            fail("Does the packing work? Test code\n" + itemMj + "Packer packer = new Packer(20);\n" + "packer.packThings(things);");
        }

        String koodi = "" + itemMj + "Packer packer = new Packer(20);\n" + "packer.packThings(things);";
    ...
    private void oikeanKokoinen(Object box, int koko) throws Throwable {
        ...
        for (int i = 1; i <= koko - alussa; i++) {
            ...
            assertTrue("When creating new Packer(20); packer must use " + "boxes of volume 20\nYou used boxes of volume " + getVolume(lodju), getVolume(lodju) == alussa + i);
        ...
        assertTrue("When creating new Packer(20); packer must use " + "boxes of volume 20\nYou used boxes of volume " + getVolume(lodju), getVolume(lodju) == koko);
    }
